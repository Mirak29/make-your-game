...
import { displayStoryPopup } from "./history.js";
...
export function affectEnemies(x, y) {
  ...
  if (numEnemies === 5) {
    displayStoryPopup("You're halfway there! Keep going!");
  } else if (numEnemies === 3) {
    displayStoryPopup("Bomby has already faced numerous challenges, overcoming each one with courage and determination. With only three enemies left, victory is within reach. Stay strong, Bomby!");
  }
